...
../launch_benchmark.sh 1 1 wasp/twitter ./bench_pr_mt -f ../../datasets/graphs/twitter.sg -n 10
../launch_benchmark.sh 0 1 wasp/road ./bench_pr_mt -f ../../datasets/graphs/road.sg -n 10
../launch_benchmark.sh 1 1 wasp/road ./bench_pr_mt -f ../../datasets/graphs/road.sg -n 10
