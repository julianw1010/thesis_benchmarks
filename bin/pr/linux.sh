...
../launch_benchmark.sh 0 1 linux/kron30 ./bench_pr_mt -f ../../datasets/graphs/kron30.sg -n 10
../launch_benchmark.sh 1 1 linux/kron30 ./bench_pr_mt -f ../../datasets/graphs/kron30.sg -n 10
../launch_benchmark.sh 0 1 linux/uni30 ./bench_pr_mt -f ../../datasets/graphs/uni30.sg -n 10
../launch_benchmark.sh 1 1 linux/uni30 ./bench_pr_mt -f ../../datasets/graphs/uni30.sg -n 10
